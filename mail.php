   ...
   <div class="container">
      <div class="row">
         <div class="col-md-4 offset-md-4 mail-form">
            ...
            <!-- starting php code -->
            <?php
            //first we leave this input field blank  This variable will store the email address of the recipient.
            ...
            if (isset($_POST['send'])) {
               ...
               $sender = "From: sandipsanjel03@gmail.com";
            ...
            ?>
                  ...
                  <?php
                     $recipient = ""; //to reset recipient  variable is set to empty
                  } else {
                  ?>
            ...
            <form action="" method="POST">
               ...
               <div class="form-group">
                  <textarea name="message" cols="30" rows="10" class="form-control" placeholder="write message here..."></textarea>
               </div>
